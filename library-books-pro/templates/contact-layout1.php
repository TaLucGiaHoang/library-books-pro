<?php
/*
Template Name: Contact Layout 1
*/
?>
<?php global $complete;?>
<?php get_header(); ?>
                        ...
                        <div class="single_post_content">
                                <!--THE CONTENT START-->
                                    ...
                                    <div class="contact-layout1-area">
                                        ...
                                        <?php if(!empty($complete['contact_google_map'])){   ?>
                                        	<iframe height="300" frameborder="0" width="98%" src="<?php echo $complete['contact_google_map'];?>"></iframe><?php } ?>
                                        </div>
