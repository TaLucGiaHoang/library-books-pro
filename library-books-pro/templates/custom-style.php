<?php 
/**
 * The Custom Style for Library Books Pro
 *
...
.ptmore{background-color:<?php echo $complete['featured_block_button_bg'] ?>;}
.ptmore:hover{background-color:<?php echo $complete['featured_block_hover_button_bg'] ?>;}
...
/*-----------------------------COLORS------------------------------------*/
		...
		.slidebtn a:hover{background-color:<?php echo $complete['sldbtn_hvcolor_id']; ?>; color:<?php echo $complete['sldbtn_hvtextcolor_id']; ?>;}	
...
.ptgo, .ptgo:hover{background-color:<?php echo $complete['go_bg_color'] ?>;}
...
#footer .footercols4 h3::after{background-color: <?php echo $complete['footer_title_color']; ?>;}
<?php } ?>
...
.footmenu li a{color: <?php echo $complete['footer_menu_color']; ?>;}
.footmenu li a:hover,
