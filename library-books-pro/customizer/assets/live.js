...
// --------------------------------
	...
	wp.customize( 'complete[featured_block_button]', function( value ) { value.bind( function( newval ) { $( '.ptmore' ).html( newval );  } );  } );	
	
 	// Sections Featured Block Button
	wp.customize( 'complete[recentpost_block_button]', function( value ) { value.bind( function( newval ) { $( '.ptmore' ).html( newval );  } );  } );	
	...
	wp.customize( 'complete[go_bg_color]', function( value ) { value.bind( function( newval ) {  
		$('.ptgo').css({"background-color":newval});  } );   
	} );	
