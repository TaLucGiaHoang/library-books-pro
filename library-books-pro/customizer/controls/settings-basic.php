...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonialbox_color_id', array(
	'label' => __('Testimonial Box Bgcolor','complete'),
	'section' => 'general_color_section',
...
// Testimonial Box Border Color
$wp_customize->add_setting( 'complete[testimonialbox_border_color]', array(
	'type' => 'option',
	'default' => '#e8e7e7',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'testimonialbox_border_color', array(
	'label' => __('Testimonial Box Border Color','complete'),
	'section' => 'general_color_section',
	'settings' => 'complete[testimonialbox_border_color]',
) ) );
