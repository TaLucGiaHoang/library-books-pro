...
$wp_customize->add_setting('complete[phntp_text_id]', array(
	'type' => 'option',
	'default' => __('<span style="line-height: 38px;"><i class="fa fa-map-marker" aria-hidden="true"></i> Street 238,52 tempor Donec ultricies mattis nulla, suscipit</span>','complete'),
...
$wp_customize->add_setting('complete[suptp_text]', array(
	'type' => 'option',
	'default' => __('<strong style="font-size: 22px;">+10-88-888-888</strong>','complete'),
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
